...
echo URL=file:///%CD%/outlook_com_addin_final.py >> "%USERPROFILE%\Desktop\AI Email Manager.url"
...
echo URL=file:///%CD%/outlook_com_addin_final.py >> "%APPDATA%\Microsoft\Windows\Start Menu\Programs\AI Email Manager.url"
...
echo    python outlook_com_addin_final.py
...
echo.
echo 📞 תמיכה:
echo - בדוק את הלוגים ב-outlook_com_addin_final.log
