# Outlook Email Manager - Run Script for app_with_ai.py
# סקריפט הרצה למערכת ניהול מיילים חכמה עם AI

# הגדרת קידוד UTF-8 לתמיכה בעברית
[Console]::OutputEncoding = [System.Text.Encoding]::UTF8
$OutputEncoding = [System.Text.Encoding]::UTF8

Write-Host "🚀 Outlook Email Manager - AI Version" -ForegroundColor Green
