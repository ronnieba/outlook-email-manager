...
def create_inproc_addin():
    """יוצר תוסף COM שירוץ כ-InprocServer32"""
    
    # קוד Python שיוצר DLL
    python_code = '''
import sys
import os
import tempfile
...
'''
    ...
    # כתיבת הקוד לקובץ
    with open('inproc_com_addin.py', 'w', encoding='utf-8') as f:
        f.write(python_code)
    
    print("Created inproc_com_addin.py")
    return True

if __name__ == '__main__':
    print("Creating Inproc COM Addin...")
    create_inproc_addin()
    print("Inproc COM Addin source created!")
