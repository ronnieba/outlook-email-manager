# -*- coding: utf-8 -*-
"""
AI Email Manager - מנתח מיילים פשוט שעובד
גרסה פשוטה ללא לולאות מורכבות
"""
...
def main():
    """פונקציה ראשית"""
    print("="*60)
    print("AI Email Manager - מנתח מיילים פשוט")
    print("="*60)
    print()
    print("הוראות:")
    ...
    print("4. לחץ Enter להתחלת הניתוח")
    print()
    
    input("לחץ Enter להתחלת הניתוח...")
